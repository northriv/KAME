...
static const double cg_48fSitePositions[48][3] = {
    {X,1,1}, {X+4,5,1}, {X,5,5}, {X+4,1,5},
    {1,X,1}, {5,X+4,1}, {1,X+4,5}, {5,X,5},
    {1,1,X}, {5,5,X}, {1,5,X+4}, {5,1,X+4},
    {-X+6,1,5}, {-X+10,5,5}, {-X+6,5,1}, {-X+10,1,1},
    {5,-X+6,1}, {1,-X+10,1}, {5,-X+10,5}, {1,-X+6,5},
    {1,5,-X+6}, {5,1,-X+6}, {1,1,-X+10}, {5,5,-X+10},
    {7,X+2,3}, {3,X-2,3}, {7,X-2,7}, {3,X+2,7},
    {X-2,3,3}, {X+2,7,3}, {X-2,7,7}, {X+2,3,7},
    {3,3,X-2}, {7,7,X-2}, {3,7,X+2}, {7,3,X+2},
    {7,-X+8,7}, {3,-X+4,7}, {7,-X+4,3}, {3,-X+8,3},
    {-X+4,7,3}, {-X+8,3,3}, {-X+4,3,7}, {-X+8,7,7},
    {7,3,-X+4}, {3,7,-X+4}, {7,7,-X+8}, {3,3,-X+8}
};
