...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/core/release/ -lflowcontrollercore
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/core/debug/ -lflowcontrollercore
else:unix: LIBS += -L$$OUT_PWD/core/ -lflowcontrollercore
