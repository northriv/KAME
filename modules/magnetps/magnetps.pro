...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/core/release/ -lmagnetpscore
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/core/debug/ -lmagnetpscore
else:unix: LIBS += -L$$OUT_PWD/core/ -lmagnetpscore
