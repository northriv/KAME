...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/core/release/ -ldmmcore
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/core/debug/ -ldmmcore
else:unix: LIBS += -L$$OUT_PWD/core/ -ldmmcore
