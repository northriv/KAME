...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/core/release/ -lnetworkanalyzercore
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/core/debug/ -lnetworkanalyzercore
else:unix: LIBS += -L$$OUT_PWD/core/ -lnetworkanalyzercore
