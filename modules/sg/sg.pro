...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/core/release/ -lsgcore
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/core/debug/ -lsgcore
else:unix: LIBS += -L$$OUT_PWD/core/ -lsgcore
