...
// Tuning macros (KAME_STM_*, KAME_LEASE_*, KAME_DT2_FAIRNESS_US, etc.)
// live in transaction_definitions.h (included by transaction.h and the
// negotiation headers above). Out-of-class NegotiationCounter members
// and the negotiate_internal() body live in transaction_neg_impl.h.
