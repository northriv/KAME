...
(kernel `4.18.0-372.9.1.el8.x86_64`); kame at `d7aabc90`, mimalloc-bench
at `941c265d` (allocator versions are whatever that revision of
mimalloc-bench builds via its `build-bench-env.sh`).
